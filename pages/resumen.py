        ...
        [
            ...
            html.Div(
                [
                    html.Div([
                        'Seleccione empresa',
                        dcc.Dropdown(id='Emp1', options=emp_dict.loc['Empresa'].unique(), value=[emp_dict.loc['Empresa'].unique()[0]], clearable=False, multi=True), # Selección de la simulación
                    ], className='no-print'),
                    html.Br([]),
                    html.Div([
                        'Seleccione caso',
                    ...
                    html.Div([
                        'Seleccione central',
                        dcc.Dropdown(id = 'Cen1', value=auxCBcen_df['cen_nom'].unique()[0]), # Selección de la central (por nombre)
                    ], className='no-print'),
            ...
            html.Div(
                [
                    ...
                    html.Div([
                        ...
                        dcc.Dropdown(id='Bar1', options=ret['Engie']['BarraPLP'].unique(), value='EntreRios220', clearable=False), # Selección de la simulación
                    ], className='no-print'),
                    html.Br([]),
                    # Row 3
                    html.Div(

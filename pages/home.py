        ...
        [
            ...
            html.Div(
                [
                    html.Div([
                        'Seleccione empresa',
                        dcc.Dropdown(id='Emp', options=emp_dict.loc['Empresa'].unique(), value=emp_dict.loc['Empresa'].unique()[0], clearable=False), # Selección de la simulación
                    ]),
                    html.Div([
                        'Seleccione caso',
                        dcc.Dropdown(id='Caso', options=['Caso base', 'Caso falla CTA engie'], value='Caso base', clearable=False), # Selección de la simulación
                    ]),
                    html.Div([
                        'Seleccione central',
                        dcc.Dropdown(id = 'Cen', value=cen_df['cen_nom'].unique()[0]), # Selección de la central (por nombre)
                    ]),
                    html.Div([
                        'Seleccione simulación',
                        dcc.Dropdown(id='Sim', options=cen_df['Hidro'].unique(), value=cen_df['Hidro'].unique()[0], clearable=False), # Selección de la simulación
                    ]),
                    # Row 3
                    html.Div(
                        [
...
@callback(
    [Output(component_id='margen_planta', component_property='figure'),
     Output(component_id='c_var', component_property='figure'),
